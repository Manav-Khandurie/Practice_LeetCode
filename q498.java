    ...
    public int[] findDiagonalOrder(int[][] arr) {
        ...
        for (i = 0; i < n; i++) {
            ...
            if (alter % 2 == 0) {
                ...
                int k = 0;
                while (check(k, t)) {
                    // al.addFirst(arr[k][t]);/* add First and Last are not recognized sometimes ,
                    // uncomment*/
                    k++;
                    t--;
                }
                ...
                t = 0; // 1,0
                while (check(t, k)) {
                    // al.addLast(arr[t][k]);/* add First and Last are not recognized sometimes,
                    // uncomment*/
                    k--;
                    t++;
                }
        ...
        for (i = 1; i < m; i++, alter++) {
            ...
            if (alter % 2 == 0) {
                ...
                int k = n - 1;
                while (check(t, k)) {
                    // al.addFirst(arr[t][k]);/* add First and Last are not recognized sometimes,
                    // uncomment*/
                    k--;
                    t++;
                }
